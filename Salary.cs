...
namespace PayrollSystem
{
    public partial class Salary : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Base Salary: PHP " + BasSal, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 250));
            e.Graphics.DrawString("HR: PHP " + hr, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 270));
            e.Graphics.DrawString("DA: PHP " + da, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 290));
            e.Graphics.DrawString("TA: PHP " + ta, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 310));
            e.Graphics.DrawString("Attendance Salary: PHP " + AttSalary, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 330));
            e.Graphics.DrawString("Bonus: PHP " + Bonus, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 350));
            ...
            e.Graphics.DrawString("Tax: PHP " + Tax, new Font("Arial", 8, FontStyle.Bold), Brushes.Black, new Point(50, 390));
            ...
            e.Graphics.DrawString("Total: PHP " + Balance, new Font("Arial", 10, FontStyle.Bold), Brushes.Blue, new Point(50, 470));
        ...
        private void ComputeBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                BalanceTb.Text = "PHP " + DGrdTot;
                DedTb.Text = "PHP " + Deduct;
                hra.Text = "PHP " + hr;
                textBox2.Text = "PHP " + da;
                textBox3.Text = "PHP " + ta;
